function CategoryController() {
    ...
    this.loadData = function() {
        ...
        util.xhrGetSync("/res/events?series_id=" + series_id, function(response) {
        ...
        if (id === undefined) {
            ...
            util.xhrGet("/res/categories/" + id, function(response) {
    ...
    this.save = function() {
        fillCategory();
        util.xhrPost("/res/categories/", function(response) {
            parseAndFill(response);
