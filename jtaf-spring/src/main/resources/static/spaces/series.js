function SeriesController() {
    ...
    this.loadData = function() {
        ...
        if (series_id === undefined) {
            ...
            util.xhrGet("/res/series/" + series_id, function(response) {
                parseAndFillSeries(response);
                util.i18n();

                util.xhrGet("/res/categories?series_id=" + series_id, function(response) {
                    parseAndFillCategories(response);
                    util.i18n();
                });
                util.xhrGet("/res/events?series_id=" + series_id, function(response) {
                    parseAndFillEvents(response);
                    util.i18n();
                });
                util.xhrGet("/res/athletes?series_id=" + series_id, function(response) {
        ...
        logoimage.src = "/res/series/logo/" + series_id;
    ...
    this.save = function() {
        fillSeries();
        util.xhrPost("/res/series/", function(response) {
            parseAndFillSeries(response);
    ...
    this.uploadLogo = function() {
        ...
        form.setAttribute("action", "/res/series/upload/" + series_id);
        form.submit();
    };
    ...
    this.deleteCompetition = function(id) {
        if (confirm(util.translate("Are you sure?"))) {
            util.xhrDelete("/res/competitions/" + id, function() {
                self.loadData();
    ...
    this.deleteEvent = function(id) {
        if (confirm(util.translate("Are you sure?"))) {
            util.xhrDelete("/res/events/" + id, function() {
                self.loadData();
    ...
    this.deleteAthlete = function(id) {
        if (confirm(util.translate("Are you sure?"))) {
            util.xhrDelete("/res/athletes/" + id, function() {
                self.loadData();
    ...
    this.deleteCategory = function(id) {
        if (confirm(util.translate("Are you sure?"))) {
            util.xhrDelete("/res/categories/" + id, function() {
                self.loadData();
    ...
    this.recalculateCategories = function() {
        if (confirm(util.translate("All results of this series will be deleted!\nAre you sure?"))) {
            util.xhrPost("/res/series/recalculateCategories", function(response) {
                self.loadData();
    ...
    function fillCompetitionTable() {
        ...
        if (series.competitions === undefined || series.competitions.length === 0) {
            ...
            series.competitions.forEach(function(competition) {
                ...
                sheet.setAttribute("href", "/res/reports/sheets?competitionid=" + competition.id);
                ...
                sheetOrderByClub.setAttribute("href", "/res/reports/sheets?orderby=club&competitionid=" + competition.id);
                ...
                numbers.setAttribute("href", "/res/reports/numbers?competitionid=" + competition.id);
                ...
                numbersOrderByClub.setAttribute("href", "/res/reports/numbers?competitionid=" + competition.id + "&orderby=club");
    ...
    function parseAndFillCategories(response) {
        ...
        if (categories === undefined || categories.length === 0) {
            ...
            categories.forEach(function(category) {
                ...
                var sheet = document.createElement("a");
                sheet.setAttribute("href", "/res/reports/sheets?categoryid=" + category.id);
                sheet.setAttribute("target", "_blank");
