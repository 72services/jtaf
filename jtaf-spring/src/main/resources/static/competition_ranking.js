function CompetitionsRankingController() {
    ...
    this.loadData = function() {
        ...
        if (competition_id === undefined) {
            ...
            util.xhrGet("/res/rankings/competition/" + competition_id, function(response) {
    ...
    this.openAsPdf = function() {
        ...
        newtab.location.href = "/res/rankings/competition/pdf/" + ranking.competition.id;
    };


    this.createEventsRanking = function() {
        var newtab = window.open();
        newtab.location.href = "/res/rankings/events/" + ranking.competition.id;
    };

    this.createDiplomas = function() {
        var newtab = window.open();
        newtab.location.href = "/res/rankings/diploma/" + ranking.competition.id;
    };
    ...
    function calculateNumberOfMedals(category) {
        ...
        if (ranking.competition.medalPercentage !== null
            ...
            if (numberOfMedals < 3 && ranking.competition.alwaysThreeMedals) {
                numberOfMedals = 3;
            }
        }
