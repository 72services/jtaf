function SeriesRankingController() {
    ...
    this.loadData = function() {
        ...
        if (id === undefined) {
            ...
            util.xhrGet("/res/rankings/series/" + id, function(response) {
    ...
    this.openAsPdf = function() {
        ...
        newtab.location.href = "/res/rankings/series/pdf/" + ranking.series.id;
    };
    
    this.createClubRanking = function() {
        var newtab = window.open();
        newtab.location.href = "/res/rankings/club/" + ranking.series.id;
    };
